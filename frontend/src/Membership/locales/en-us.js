const enUS = {
  buttons: {
    ...
    view_personal_info: "View Personal Info",
    booking: "My Booking",
  ...
  form_message: {
    ...
    email_not_valid: "The input is not valid Email !",
  ...
  alert_message: {
    ...
    email_verify: "Email is not verified, please verify your email",
