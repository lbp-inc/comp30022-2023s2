...
import './Forms.css';
import NavigableForm from "./NavigableForm";
        ...
        <>
            <div className="body_details">
                ...
                <Form onSubmit={submitForm}>
                    <NavigableForm>
                        <NavigableForm.Item sectionId="s1" sectionName="Personal Details">
                            <Row>
                                <Col>
                        ...
                        <NavigableForm.Item sectionId="s2" sectionName="Emergency Contact">
                        ...
                        <NavigableForm.Item sectionId="s3" sectionName="Volunteering Information">
