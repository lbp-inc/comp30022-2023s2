...
const ACFEForm = () => {
    ...
    return (
        <BookingForm onSubmit={SubmitForm}>
            <BookingForm.Section sectionId="s1" sectionName="Personal Details">
                ...
                <FloatingLabel controlId="ACFE.ECrelationship" label="Relationship to you">
                    <Form.Control type="relationship" placeholder="Train Conductor"
                                  defaultValue={formData.ecRelationship}
            ...
            <BookingForm.Section sectionId="s2" sectionName="Citizen Check">
                <Form.Label>
                    To be eligible for an ACFE funded course at Longbeach PLACE, you must tick one of the following
                    boxes and provide evidence
                ...
                <Form.Control controlId="ACFE.proveFile" type="file" size="sm"
                              onChange={(e) => inputChange('proveFile', e.target.files[0])}/>
            </BookingForm.Section>
            <BookingForm.Section sectionId="s3" sectionName="Language & Culture">
                <FloatingLabel controlId="ACFE.bornCountry" label="What country were you born in?">
                    <Form.Control type="contry" placeholder="Australia"
                                  onChange={(e) => inputChange('bornCountry', e.target.value)}/>
                </FloatingLabel><br></br>
                <FloatingLabel controlId="ACFE.homeLanguage" label="What Language do you speak at home?">
                    <Form.Control type="language" placeholder="English"
                                  onChange={(e) => inputChange('homeLanguage', e.target.value)}/>
                </FloatingLabel><br></br>
            ...
            <BookingForm.Section sectionId="s4" sectionName="Student Support">
                ...
                <Form.Text>
                    If you have any needs that would cause a barrier to your learning or assessment, please let us know.
                    We will work with you to identify what reasonable adjustments or flexibility you may need to
                    participate.
                </Form.Text><br/>
                <FloatingLabel controlId="ACFE.supportNeeded" label="If yes, what support would you require?">
                    <Form.Control type="support" placeholder="WheelChair"
                                  onChange={(e) => inputChange('supportNeed', e.target.value)}/>
                </FloatingLabel>
                <Form.Text muted>
                    <i> ( eg: I need wheelchair access) </i>
                </Form.Text><br/>
            </BookingForm.Section>
            <BookingForm.Section sectionId="s5" sectionName="VIC Student Number">
                <b> To be completed by all students aged up to 24 years </b> <br/>
                <Form.Text>
                    Have you attended any Victorian school since 2009 or done any training with a vocational education &
                    training (VET) registered training organisation or an Adult and community Education provider in
                    Victoria since 2011?
                </Form.Text><br/><br/>
                <Form.Check
                    type={'radio'}
                ...
                />
                <Form.Text>
                    I have not attended a Victorian school since 2009 or a TAFE or other VET training provider since the
                    beginning of 2011
                </Form.Text><br/>
                <Form.Check
                    type={'radio'}
                ...
                <Form.Group className="mb-3" controlId="ACFE.VicSchoolAttend">
                    ...
                    <Form.Control type="vicSchool" placeholder="Fill-in if applicable"
                                  onChange={(e) => inputChange('schoolAttend', e.target.value)}/>
                </Form.Group>
                ...
                <i> Students who are enrolling for the first time since the VSN number was introduced will be provided
                    with one </i>
            </BookingForm.Section>
            <BookingForm.Section sectionId="s6" sectionName="Prev Education">
                <Form.Group>
                ...
                <Form.Group>
                    <Form.Label> <b> Have you successfully completed any of the following qualifications in
                        AUSTRALIA? </b> </Form.Label>
                    <Form.Check
                        type={'radio'}
            ...
            <BookingForm.Section sectionId="s7" sectionName="Employment">
                <Form.Group>
                    <Form.Label> <b> Of the following categories, which one BEST describes your current employment
                        status? </b> </Form.Label>
                    <Form.Check
                        type={'radio'}
            ...
            <BookingForm.Section sectionId="s8" sectionName="Extra Info">
                <Form.Group>
                    <Form.Label> <b> Of the following categories, which one best describes your main reason for
                        attending? </b> </Form.Label>
                    <Form.Check
                        type={'radio'}
                        name={'studyReason'}
                        id={`ACFE.job1`}
                ...
                <Form.Group>
                    ...
                    <Form.Control size="sm" type="text" placeholder="(please specify)"
                                  onChange={(e) => inputChange("knownFrom", e.target.value)}/>
                </Form.Group>
            </BookingForm.Section>
            <BookingForm.Section sectionId="s9" sectionName="Terms & Statements">
                ...
                <h4><u> Payments </u></h4>
                <p>
                    Payments must accompany completed registration form with evidence of residency to confirm place.
                    Early enrolment is essential. Enrolments close when classes are filled. Classes will commence on the
                    date shown unless otherwise notified.
                </p>

                <h4><u> Refunds </u></h4>
                <p>
                    <b>Please choose your course carefully. Longbeach PLACE is not responsible for changes in your
                        circumstances.</b> A refund will be issued if at least 5 working days' notice is given prior to
                    the course start date. An administration fee of $10 will apply and be deducted from the refund. In
                    the event that Longbeach PLACE has to cancel a course due to low enrolments, you will be notified
                    prior to the start date and a full refund will be issued as soon as possible. If Longbeach PLACE
                    defers a course and the new dates are not suitable, a full refund will be issued. <b><u>Please
                    Note</u>: NO REFUND OR TRANSFER will be available after a course has started</b> (due to our
                    Not-for-Profit status).
                </p>

                <h4><u> Privacy Statement </u></h4>
                <p>
                    <b>I understand that:</b> Longbeach PLACE Inc is required to provide the Victorian Government,
                    through the Department of Education and Training, with student and training activity data which may
                    include information I provide in this enrolment form. Information is required to be provided in
                    accordance with the Victorian VET Student Statistical Collection Guidelines (Which are available
                    at <a
                    href="http://www.education.vic.gov.au/training/organisations/rto/Pages/datacollection.aspx">here</a>).
                    The Department may use the information provided to it for planning, administration, policy
                    development, program evaluation, resource allocation, reporting and/or research activities. For
                    these and other lawful purposes, the Department may also disclose information to its consultants,
                    advisers, other government agencies, professional bodies and/or other organisations. I have been
                    advised by the training organisation that I may be contacted and requested to participate in a
                    National Centre for Vocational Education Research survey or a Department-endorsed project or audit
                    or review.
                </p>
                <p>
                    Longbeach PLACE Inc will not give personal information about you to anyone else without your written
                    permission. This is the law known as the Privacy Act (2001).
                </p>
                <p>
                    The Education and Training Reform Act 2006 requires Longbeach PLACE Inc to collect and disclose my
                    personal information for a number of purposes including the allocation to me of a Victorian Student
                    Number and updating my personal information on the Victorian Student Register (applies to persons
                    aged 29 and under)
                </p>
                <p>
                    For more information in relation to how student information may be used or disclosed please contact
                    Longbeach PLACE Inc Privacy Officer on phone 9776 1386 or email <u>admin@longbeachplace.org.au</u>
                </p>

                <h4> Signature & Declaration </h4>
                <ul>
                    <li> If there is an emergency I allow those in charge to make decisions for my safety or well-being,
                        including ambulance travel, medical treatment, and hospitalisation.
                    </li>
                    ...
                    <li> I understand that Longbeach PLACE has a Privacy and Grievance Policy and is committed to
                        keeping personal information secure. Students may access the Privacy and Grievance Police from
                        the Longbeach PLACE website, and may access their personal records upon request.
                    </li>
                ...
                <p>
                    Allow photographs/videos of me to be taken, or any of the written work that is completed as part of
                    my classes at Longbeach PLACE, to be used for display on TV screens, web pages or brochures/posters,
                    video/audio, newsletters, newspaper articles or Annual Reports.
                </p>
                <Form.Check
                    inline
                    name='agreement'
                ...
                <FloatingLabel controlId="ACFE.guardianName" label="Parent/Guardian Name">
                    <Form.Control type="name" placeholder=''
                                  onChange={(e) => inputChange('guardianName', e.target.value)}/>
                </FloatingLabel>
            ...
            <Form.Text id="PaymentNotice" muted>
                This registration may require a payment for few dollars.<br/>
            </Form.Text>
        </BookingForm>
    )
};
